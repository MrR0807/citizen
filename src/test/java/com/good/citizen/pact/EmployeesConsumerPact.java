...
//    public RequestResponsePact createPactThree(PactDslWithProvider builder) {
//        return builder
//                .given("SomeProviderState")
//                .uponReceiving("Post employee")
...
//        return LambdaDsl.newJsonBody(request -> request
//                .numberType("socialSecurityNumber", 1234567)
//                .stringValue("firstName", "First")
//                .stringValue("lastName", "Lastname")
//                .stringMatcher("jobTitle", "SOFTWARE_DEVELOPER|BUSINESS_ANALYST|PRODUCT_OWNER")
//                .stringValue("team", "Red"))
//                .build();
//    }
//
...
//        return LambdaDsl.newJsonBody(employee -> employee
//                .id()
//                .valueFromProviderState("socialSecurityNumber", "socialSecurityNumber", 12345)
//                .stringValue("firstName", "First")
//                .stringValue("lastName", "Lastname")
//                .stringMatcher("jobTitle", "SOFTWARE_DEVELOPER|BUSINESS_ANALYST|PRODUCT_OWNER")
//                .stringValue("team", "Red"))
...
//
//    @Test
//    @PactTestFor(pactMethod = "createPactThree")
//    void nameThree(MockServer mockServer) throws IOException, InterruptedException {
//        var port = mockServer.getPort();
//        System.out.println(port);
//
//        var httpClient = HttpClient.newHttpClient();
//        var request = HttpRequest.newBuilder(URI.create("http://localhost:" + port + "/api/v1/employees"))
